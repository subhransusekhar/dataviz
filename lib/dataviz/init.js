var DataViz = {
	...
	drawVisualization: function() {
		  // To see the data that this visualization uses, browse to
			DataViz.query = new google.visualization.Query('http://spreadsheets.google.com/tq?key=0B_UVLpCtvU0NUFJNanVQaUszd2c&range=B1:C11');
	...
	_populate_lat_lon: function() {
		...
		if(typeof(geo_index['lat']) !== 'undefined') {
			DataViz._populat_available_field(geo_index['lat']);
		}
		if(typeof(geo_index['lon']) !== 'undefined') {
			DataViz._populat_available_field(geo_index['lon']);
		}
	},
	...
	executeQuery: function(){
		...
		$('#data_viz_query').html(custom_query);
	},
	...
	_populat_available_field: function(index_val) {
